...
namespace lmgtusecase.Publisher
{
    ...
    {
        public EditPublisher(List<IPublisherValidator> publisherValidators,IPublisherRepository publisherRepository,
        ...
        public async Task<bool> EditAsync(EditPublisherInputModel inputModel,int creatingUserID)
        {
            ...
            await _PublisherRepository.UpdateAsync(_ToPublisherDtoConverter.Convert(inputModel));
